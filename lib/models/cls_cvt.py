...
class Regional_Local_ML_Attention(nn.Module):
    ...
    def __init__(self,
        ...
        self.mix_locally = nn.Sequential(OrderedDict([
            ('translation', nn.Conv2d(dim_in, dim_in, 
                                     kernel_size = 3, padding = 1, stride = 1, 
                                     groups = dim_in // kwargs['conv_inflate'])),
            ('group', P4MConvP4M(in_channels = dim_in // 8,
                               out_channels = dim_in // 8,
